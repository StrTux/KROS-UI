...
const components = [
  ...
  { id: 'hover-card', name: 'Hover Card', status: 'done' },
  ...
  { id: 'navigation-menu', name: 'Navigation Menu', status: 'done' },
  { id: 'pagination', name: 'Pagination', status: 'done' },
  { id: 'popover', name: 'Popover', status: 'done' },
  { id: 'progress', name: 'Progress', status: 'done' },
  { id: 'radio-group', name: 'Radio Group', status: 'done' },
  { id: 'resizable', name: 'Resizable', status: 'done' },
  { id: 'scroll-area', name: 'Scroll Area', status: 'done' },
  { id: 'select', name: 'Select', status: 'done' },
  { id: 'separator', name: 'Separator', status: 'done' },
  { id: 'sheet', name: 'Sheet', status: 'done' },
  { id: 'sidebar', name: 'Sidebar', status: 'done' },
  { id: 'skeleton', name: 'Skeleton', status: 'done' },
  { id: 'slider', name: 'Slider', status: 'done' },
  { id: 'sonner', name: 'Sonner', status: 'done' },
  ...
  { id: 'toast', name: 'Toast', status: 'done' },
  { id: 'toggle', name: 'Toggle', status: 'done' },
  { id: 'toggle-group', name: 'Toggle Group', status: 'done' },
  { id: 'tooltip', name: 'Tooltip', status: 'done' },
];
